<?php
/*
Plugin Name: Quantity Field on Shop Page for WooCommerce Modded
GitHub Plugin URI: gambe/quantity-field-on-shop-page-for-woocommerce-modded
...
class woa_wqfsp {
	...
	public function woa_confirm_add() {
		...
		jQuery(".added_to_cart").after("<p class=\'confirm_add\'>Aggiunto</p>");
});
